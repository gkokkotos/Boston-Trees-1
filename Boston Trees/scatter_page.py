...
def setup_scatter_neighborhood_page():
    """Setup scatter page title, sidebar filters, and return filtered df."""
...
def create_scatter_neighborhood(df_filtered):
    """Create and display scatterplot of diameter by neighborhood."""
...
def scatter_page():
    """Main function for the diameter vs neighborhood scatterplot page."""
